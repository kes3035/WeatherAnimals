...
final class DetailVC: UIViewController {
    ...
    private lazy var detailCollectionView = UICollectionView(frame: .zero, collectionViewLayout: flowLayout).then {
        ...
        //        $0.register(ItemsReusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: ItemsReusableView.identifier) //Header 등록
    ...
    private func settingFlowLayout() {
        ...
        //        flowLayout.layoutAttributesForSupplementaryView(ofKind: <#T##String#>, at: <#T##IndexPath#>)
